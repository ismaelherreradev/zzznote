...
--> statement-breakpoint
DROP TABLE `zzznote_accounts`;--> statement-breakpoint
DROP TABLE `zzznote_magic_links`;--> statement-breakpoint
DROP TABLE `zzznote_profile`;--> statement-breakpoint
DROP TABLE `zzznote_session`;--> statement-breakpoint
DROP TABLE `zzznote_user`;--> statement-breakpoint
